<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li class="menu-label">Frontend Elements [Landing]</li>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.slider') }}"><i class="bx bx-right-arrow-alt"></i>All
                                Slider</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('add.landing.slider') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Slider</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('slider.menu'))
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.about') }}"><i class="bx bx-right-arrow-alt">
                                </i>All About</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('slider.menu'))
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.testimonial') }}"><i class="bx bx-right-arrow-alt">
                                </i>All Testimonial</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('add.landing.testimonial') }}"><i class="bx bx-right-arrow-alt">
                                </i>Add Testimonial</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('slider.menu'))
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.service') }}"><i class="bx bx-right-arrow-alt">
                                </i>All Services</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('add.landing.service') }}"><i class="bx bx-right-arrow-alt">
                                </i>Add Services</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('slider.menu'))
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.company') }}"><i class="bx bx-right-arrow-alt">
                                </i>All Company</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('add.landing.company') }}"><i class="bx bx-right-arrow-alt">
                                </i>Add Company</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('slider.menu'))
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.team') }}"><i class="bx bx-right-arrow-alt">
                                </i>All Team</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('add.landing.team') }}"><i class="bx bx-right-arrow-alt">
                                </i>Add Team</a>
                        </li>
                    @endif
        ...
        @if (Auth::user()->can('slider.menu'))
            <li>
                <a href="javascript:;" class="has-arrow">
                    ...
                    <div class="menu-title">Sub-Team</div>
                </a>
                <ul>
                    @if (Auth::user()->can('slider.list'))
                        <li> <a href="{{ route('all.landing.sub_team') }}"><i class="bx bx-right-arrow-alt">
                                </i>All Sub-Team</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('slider.add'))
                        <li> <a href="{{ route('add.landing.sub_team') }}"><i class="bx bx-right-arrow-alt">
                                </i>Add Sub-Team</a>
                        </li>
                    @endif
        ...
        <li class="menu-label">Frontend Elements [Fashion]</li>
            ...
            <li>
                ...
                <ul>
                    @if (Auth::user()->can('category.list'))
                        <li> <a href="{{ route('all.category') }}"><i class="bx bx-right-arrow-alt"></i>All
                                Category</a>
                        </li>
                    @endif
                    @if (Auth::user()->can('category.add'))
                        <li> <a href="{{ route('add.category') }}"><i class="bx bx-right-arrow-alt"></i>Add
                                Category</a>
                        </li>
                    @endif
